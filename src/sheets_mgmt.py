...
def build_leiame(wb):
    ...
    passos = ["1. Configure a entidade em 00_CONFIGURAÇÃO (ano, mês de reporte, regime, limites).",
              ...
              "4. Lance cada operação UMA vez em 02_DIÁRIO_LANÇAMENTOS (partidas dobradas, mesmo ID para todas as linhas). Liquidações: indique o ID do documento de origem em Ref_Origem_ID.",
