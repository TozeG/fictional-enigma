...
1. **Tabela do IRT (Grupo A)** — **≤ 2024**: Lei n.º 28/20 (13 escalões, isenção 70 000 Kz; tabela AGT). **2025**: Lei n.º 18/24, art. 20.º n.º 3 e Anexo I (DR I Série n.º 247, 30/12/2024, p. 13798 — fonte primária; isenção 100 000 Kz, 12 escalões). Ambas carregadas e testadas (`tests/test_irt.py`). **2026**: Lei n.º 14/25, art. 21.º n.º 3 e Anexo I — isenção 150 000 Kz aplicada; **escalões por carregar**. Nota: o Anexo I da Lei 18/24 está impresso no DR com o título "TABELA DO IRT (Proposta)" e a base de cálculo é o "excesso de" 100 001, 150 001, … (transcrito tal como publicado).
